...
That's a question that I've been asked time and time again after helping someone complete this guide. This page is a non-exhaustive guide of a bunch of things you can (but not necessarily everything you should) do with murkmod.
...
Windows needs drivers. Lots of them! Beware that this takes up a lot of space, too, so it might not be best for your 20gb EMMC Chromebook. If you still insist on running Windows for some horrible reason, go [here](https://docs.chrultrabook.com) for more info. If you have money to spare, simply buy them from CoolStar.
