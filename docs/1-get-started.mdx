...
1. Log out of your device (`Ctrl+Shift+Q+Q`)
1. Look at the bottom left of the screen for an "Apps" option. Remember if this option is there.

#### Section IV - Select a Method

To find the correct exploit method for your device, just follow this flow chart:

![Replace All Button](\img\Flow.png)

And here's your pages:

[BadRecovery](exploits/badrecovery)

[BR1CK (third party website)](exploits/br1ck)